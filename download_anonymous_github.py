...
def download_repo(url="https://anonymous.4open.science/r/DPPBench/", save_dir='.', max_conns=10, max_retry=5):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--url', type=str, help='Github repo url', default='https://anonymous.4open.science/r/DPPBench/')
